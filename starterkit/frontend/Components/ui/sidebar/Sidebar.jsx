/**
 * Port of the shadcn/ui Sidebar (Tailwind v3). Unlike upstream, the provider is
 * controlled: open state lives in the layout (see composables/useSidebar.js),
 * so these primitives stay presentational.
 */
...
function useSidebarContext() {
  ...
  if (!context) throw new Error("Sidebar components must be used within a SidebarProvider.")
  return context
}

const SidebarProvider = React.forwardRef(
  ({ open, onOpenChange, openMobile, onOpenMobileChange, isMobile, className, style, children, ...props }, ref) => {
    const toggleSidebar = React.useCallback(() => {
      if (isMobile) onOpenMobileChange(!openMobile)
      else onOpenChange(!open)
    }, [isMobile, open, openMobile, onOpenChange, onOpenMobileChange])
    ...
    const value = React.useMemo(
      ...
      [open, onOpenChange, openMobile, onOpenMobileChange, isMobile, toggleSidebar]
    )
  ...
  ({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Reserves the sidebar's width in the page flow. */}
        <div
          className={cn(
